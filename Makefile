...
APP_MIME_SIG = application/x-vnd.titer-dvdrip
...
SRCS = \
	src/DVDRip.cpp  \
	src/DVDRipApp.cpp  \
	src/DVDRipFilesView.cpp  \
	src/DVDRipTitlesView.cpp  \
	src/DVDRipView.cpp  \
	src/DVDRipWin.cpp  \
	src/DVDRipWrapper.cpp  \
...
LIBS = $(STDCPPLIBS) be tracker dvdread dvdcss
